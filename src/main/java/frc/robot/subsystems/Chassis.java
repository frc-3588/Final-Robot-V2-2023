...
public class Chassis extends SubsystemBase {
    ...
    private final DifferentialDrivePoseEstimator m_poseEstimator = new DifferentialDrivePoseEstimator(
            m_kinematics, kGyro.getRotation2d(), 0.0, 0.0, new Pose2d());
    ...
    */
    public Chassis() {
        ...
        kLeftFrontEncoder.setPositionConversionFactor(Math.PI * Constants.DriveConstants.wheelDiamater);
        kRightFrontEncoder.setPositionConversionFactor(Math.PI * Constants.DriveConstants.wheelDiamater);
