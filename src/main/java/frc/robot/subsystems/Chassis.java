...
public class Chassis extends SubsystemBase {
    ...
    private final DifferentialDrivePoseEstimator m_poseEstimator = new DifferentialDrivePoseEstimator(
            DriveConstants.m_kinematics, kGyro.getRotation2d(), 0.0, 0.0, new Pose2d());
    ...
    private final RamseteController controller1;
    private final RamseteController controller2;
    ...
    */
    public Chassis() {
        ...
        // RamseteController controller2 = new RamseteController(2.1, 0.8);  we decide gains, while previous is already initialized to 2.0 and 7.0
        ...
        DifferentialDriveWheelSpeeds wheelSpeeds = DriveConstants.m_kinematics.toWheelSpeeds(adjustedSpeeds);
        double left = wheelSpeeds.leftMetersPerSecond;
        double right = wheelSpeeds.rightMetersPerSecond;

        kLeftFrontEncoder.setPositionConversionFactor(Math.PI * DriveConstants.wheelDiamater);
        kRightFrontEncoder.setPositionConversionFactor(Math.PI * DriveConstants.wheelDiamater);
    ...
    public void updateOdometry() {
        m_poseEstimator.update(
                kGyro.getRotation2d(), kLeftFrontEncoder.getPosition(), kRightFrontEncoder.getPosition());

        // Also apply vision measurements. We use 0.3 seconds in the past as an example
        // -- on
        // a real robot, this must be calculated based either on latency or timestamps.
        Optional<EstimatedRobotPose> result = vision.getEstimatedGlobalPose(m_poseEstimator.getEstimatedPosition());
