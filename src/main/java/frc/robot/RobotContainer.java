...
import frc.robot.commands.Arm.MiddleArm;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton armTopButton = new JoystickButton(operator, 3);
    armTopButton.onTrue(new ArmTop(m_arm));

    final JoystickButton armMiddleButton = new JoystickButton(operator, 4);
    armMiddleButton.onTrue(new MiddleArm(m_arm));
    ...
    final JoystickButton ArmHomeButton = new JoystickButton(operator, 1);
    ArmHomeButton.onTrue(new ArmHome(m_arm));
  }
  ...
  public Command getAutonomousCommand() {
    ...
    return new AutonomousCommand(m_chassis);
  // return null;
